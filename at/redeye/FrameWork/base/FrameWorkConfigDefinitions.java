...
public class FrameWorkConfigDefinitions {
    ...
    public static DBConfig LookAndFeel = new DBConfig ("LookAndFeel", "System", "Bestimmt das Aussehen der Benutzoberfläche. Möglicher Werte sind <System>, <Motif> oder <Metal>", new PrmDefaultCheckSuite(PrmDefaultChecksInterface.PRM_IS_LOOKANDFEEL));
